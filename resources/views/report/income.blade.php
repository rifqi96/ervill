        ...
        <div class="col-xl-12 dashboard-column">
            ...
            <section class="" id="print-area">
                <h2 class="report-title">
                    Laporan Penerimaan <div id="period-txt">{{\Carbon\Carbon::parse($report['params']['start_date'])->format('d M Y')}} - {{\Carbon\Carbon::parse($report['params']['end_date'])->format('d M Y')}}</div>
                </h2>
                <div class="invoice">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#filterBy').submit(function (e) {
                ...
                $.post("{{route('report.income.do.filterby')}}", $(this).serialize())
