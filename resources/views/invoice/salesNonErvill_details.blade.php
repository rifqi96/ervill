...
<div class="row">
    <div class="col-xl-12 dashboard-column">
        ...
        <section class="card font-size" id="print-area">
            ...
            <div class="card-block invoice">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-print-4 text-lg-right text-md-right">
                        ...
                        <div>
                            Tgl Pembayaran:
                            <b class="payment-at">{{ $invoice->payment_date ? \Carbon\Carbon::parse($invoice->payment_date)->format('d-m-Y H:i:s') : '-' }}</b>
                        </div>
                    </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $i = 1;
                                @endphp
                                @foreach($invoice->orderCustomerNonErvills as $row)
                                    <tr>
                                        <td>{{$i++}}</td>
                                        <td>
                                            {{$row->name}}
