...
@section('content')
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{route('setting.customerNonErvills.do.update')}}" method="POST">
                {{csrf_field()}} 
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{route('setting.customerNonErvills.do.delete')}}" method="POST">
                {{csrf_field()}}
                ...
                columns: [
                    ...
                    }},                    
                    {
                        ...
                        render: function ( data, type, row, meta ) {
                            ...
                            return '<a href="customerNonErvills/id/'+row.id+'" target="_blank"><button class="btn btn-sm" type="button">Lihat</button></a>' +
