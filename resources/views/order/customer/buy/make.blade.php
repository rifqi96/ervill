    ...
    <div class="row">
        <div class="col-xl-12 dashboard-column">
            <header class="box-typical-header panel-heading" style="margin-bottom: 30px;">
                ...
                <a href="{{route('order.customer.buy.index')}}"><button class="btn btn-primary">Lihat List Pindah Tangan Galon</button></a>
                <a href="{{route('order.customer.index')}}"><button class="btn btn-primary">Lihat List Pesanan Customer</button></a>
            </header>

            <section class="box-typical box-typical-padding">

                <form action="{{route('order.customer.buy.do.make')}}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 form-control-label">Jumlah Galon</label>
                        <div class="col-sm-10">
                            <p class="form-control-static"><input id="quantity" type="number" class="form-control" name="quantity" max="" min="0"></p>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-2 form-control-label">Tgl Pembelian Galon</label>
                        <div class="col-sm-10">
                            <p class="form-control-static">
                                <input type="date" class="form-control" name="buy_at" placeholder="Tgl Retur" value="{{\Carbon\Carbon::now()->toDateString()}}">
                            </p>
                        </div>
                    </div>
                    <div class="form-group row">
